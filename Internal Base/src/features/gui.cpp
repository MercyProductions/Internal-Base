...
void GUI::RenderGUI() 
{
    ...
    ImGui::NewFrame();
    {
        ...
        drawlist->AddText(center_text(pos, ImVec2(pos.x + 480, pos.y + 25), "RageByte - MWIII"), ImColor(165, 186, 197, 255), "RageByte - MWIII");
...
void GUI::WaitForLastSubmittedFrame()
{
...
FrameContext* GUI::WaitForNextFrameResources()
{
